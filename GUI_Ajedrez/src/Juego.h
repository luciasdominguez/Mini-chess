...
class Juego
{
	...
	GUI_turno* turno;
	GUI_almacenen_partidas almacen_de_partidas;
	vector<GUI_movimiento> partida_actual; // una partida es una lista de movimientos.
...
protected:
	GUI_movimiento Movimiento_ultimo;
	GUI_movimiento Movimiento_ahora;
public:
	Juego();
