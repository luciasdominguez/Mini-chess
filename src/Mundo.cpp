...
void Mundo::dibuja_controles()
{
	...
	ETSIDI::printxy("Z: ", -14, 12);
	ETSIDI::printxy("P: seleccionar partida", -14, 11);
	ETSIDI::printxy("(guion):", -14, 10);
	ETSIDI::printxy("+:", -14, 9);
	ETSIDI::printxy("5: activar cursor", -14, 8);
	ETSIDI::printxy("(punto): selecciona pieza", -14, 7);
	ETSIDI::printxy("/:", -14, 6);
	ETSIDI::printxy("0: ejecutar movimiento", -14, 5);
	ETSIDI::printxy("(asterisco): juega la gravedad", -14, 4);
	ETSIDI::printxy("(espacio): poner piezas en el almacen", -14, 3);
	//los casos 8, 9, 6, 3, 2, 1, 4, 7 no se si son o no 
...
//para hacer lo que queremos al pulsar la tecla
